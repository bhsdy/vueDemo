<template>
	<el-row class="panel m-w-1280">
        ...
        <template v-else>
          <span class="p-l-20">{{title}}改改还能用</span>
        </template>
			</el-col>
			<el-col :span="16" class="ofv-hd">
				<div class="fl p-l-20 p-r-20 top-menu" :class="{'top-active': menu.selected}" v-for="menu in topMenu" @click="switchTopMenu(menu)">{{menu.title}} 系统</div>
			</el-col>
